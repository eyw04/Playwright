...
//   // Clinic = new CurveAccount(browser, patient_first_name, patient_last_name);
//   // RCM = new CurveAccount(browser, patient_first_name, patient_last_name);
//   // DataEntry = new CurveAccount(browser, patient_first_name, patient_last_name);

//   await Clinic.CurveLogin('Monika.Clinics_all@chiroone.net');
//   await RCM.CurveLogin('RCTMgr1@chiroone.net');
//   await DataEntry.CurveLogin('Matt.Data@chiroone.net');
